defmodule CashLensWeb.CoreComponents do
  ...
  the ones you will use most in your application, such as modals, tables, and
  forms.
      ...
      >
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            ...
            >
              <%= if @title do %>
                <h2 id={"#{@id}-title"} class="text-2xl font-semibold mb-6">
                  {render_slot(@title)}
                </h2>
              <% end %>
          ...
          >
            ...
            >
              <div class="block py-4 pr-6">
                <span class={[
                  "absolute -inset-y-px right-0 -left-4 group-hover:bg-zinc-50 sm:rounded-l-xl",
  ...
  ## Examples
      ...
      <.link href={~p"/users/{user}"}>Show user</.link>
      <.link navigate={~p"/users/{user}"}>Show user</.link>
  """
  ...
  def link(%{href: to} = assigns) when is_binary(to) do
    ~H"""
  ...
  def menu_item(assigns) do
    ...
    <a
      ...
      class={[
        ...
        if(@live_action == @current_action,
          do: "bg-blue-100 text-blue-700 border-r-2 border-blue-500",
          else: "text-gray-700"
        )
      ]}
    >
