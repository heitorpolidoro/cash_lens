defmodule CashLensWeb.CoreComponents do
  ...
  attr :position, :string, default: "top-2 right-2", doc: "the position of the flash message"
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed #{@position} z-50 rounded-lg p-3 ring-1",
  ...
  attr :position, :string, default: "top-2 right-2", doc: "the position of the flash messages"

  def flash_group(assigns) do
    ~H"""
    <div id={@id}>
      <.flash kind={:info} title={gettext("Success!")} flash={@flash} position={@position} />
      <.flash kind={:error} title={gettext("Error!")} flash={@flash} position={@position} />
      <.flash
        id="client-error"
        kind={:error}
