defmodule CashLensWeb.Formatters do
  ...
  def translate_parser_type("mercadopago_cartao_pdf"), do: "Mercado Pago Cartão (PDF)"
  def translate_parser_type("mercado_pago_csv"), do: "Mercado Pago (CSV)"
  def translate_parser_type("mercado_pago_pdf"), do: "Mercado Pago (PDF)"
  def translate_parser_type("ourocard_ofx"), do: "Ourocard (OFX)"
  def translate_parser_type("ourocard_txt"), do: "Ourocard (TXT)"
