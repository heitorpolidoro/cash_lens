defmodule CashLens.Parsers.AccountFile do
  ...
  @valid_parsers ~w(bb_csv bradesco_csv mercado_pago_csv standard_ofx ourocard_ofx ourocard_txt sem_parar_pdf bradesco_cartao_pdf mercadopago_cartao_pdf mercado_pago_pdf)
