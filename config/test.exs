...
config :cash_lens, CashLensWeb.Endpoint,
  ...
  secret_key_base: System.get_env("SECRET_KEY_BASE") || "esta_chave_secreta_e_longa_o_suficiente_para_passar_na_validacao_do_plug_e_garantir_que_os_testes_funcionem_corretamente",
  server: false
